...
const testimonials = [
  {
    text: `“As an IT student, I gained valuable real-life experience while working with my team. 
    The trainers, training content, and facilities were all excellent. 
    I learned important skills like working on projects with a team and managing my time effectively.”`,
    image: `${bigHairWoman}`,
